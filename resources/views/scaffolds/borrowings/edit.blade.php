...
<div class="card card-xxl-stretch">
    ...
    <div class="card-header align-items-center border-0 mt-4">
        <h3 class="card-title align-items-start flex-column">
            <span class="fw-bolder mb-2 text-dark">Edit Borrowings</span>
            <span class="text-muted fw-bold fs-7">Edit Peminjaman</span>
        </h3>
    ...
    <!--end::Header-->
    <!--begin::Form-->
    <form class="form" action="{{ route('borrowings.update', $data->id) }}" method="POST">
        @csrf
        @method('PUT')
