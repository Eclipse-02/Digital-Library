<form action="{{ route('borrowings.destroy', $data->id) }}" method="POST" class="text-center">
    @csrf
    @method('DELETE')

    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" href="{{ route('borrowings.show', $data->id) }}" >
    ...
    {{-- <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1" href="{{ route('borrowings.edit', $data->id) }}" >
