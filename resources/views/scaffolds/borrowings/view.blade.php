...
<div class="card card-xxl-stretch">
    ...
    <div class="card-header align-items-center border-0 mt-4">
        <h3 class="card-title align-items-start flex-column">
            <span class="fw-bolder mb-2 text-dark">View Borrowings</span>
            <span class="text-muted fw-bold fs-7">Tampilan Peminjaman</span>
        </h3>
        <div class="d-flex">
    ...
    <div class="card-body pt-5">
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Borrower Name</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Book Title</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->book->title }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Borrow Date</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ Carbon\Carbon::parse($data->borrow_date)->isoFormat('dddd, D MMMM Y') }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Return Date</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ Carbon\Carbon::parse($data->return_date)->isoFormat('dddd, D MMMM Y') }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
