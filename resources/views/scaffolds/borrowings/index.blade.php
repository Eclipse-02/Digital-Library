...
<div class="card card-xxl-stretch">
    ...
    <div class="card-header align-items-center border-0 mt-4">
        <h3 class="card-title align-items-start flex-column">
            <span class="fw-bolder mb-2 text-dark">Borrowing DataTable</span>
            <span class="text-muted fw-bold fs-7">Tabel Data Peminjaman</span>
        </h3>
        <div class="d-flex">
            <div class="card-toolbar">
                <a href="{{ route('borrowings.create') }}" class="btn btn-sm btn-primary fw-bolder me-2">
                    Create
                </a>
            </div>
            <div class="card-toolbar">
