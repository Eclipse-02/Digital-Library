...
<div class="card card-xxl-stretch">
    ...
    <div class="card-header align-items-center border-0 mt-4">
        <h3 class="card-title align-items-start flex-column">
            <span class="fw-bolder mb-2 text-dark">View Books</span>
            <span class="text-muted fw-bold fs-7">Tampilan Buku</span>
        </h3>
        <div class="d-flex">
    ...
    <div class="card-body pt-5">
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->title }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->writer }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->publisher->name }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->category->name }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Number of Book(s)</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->book_count }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
