        ...
        <div class="card-body pt-5">
            ...
            <div class="fv-row mb-5">
                ...
                <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                    <span>File</span>
                    <i class="fas fa-question-circle ms-2 fs-6" data-bs-toggle="tooltip" title="Only accepts files of type .pdf & .epub"></i>
                </label>
                <!--end::Label-->
                <!--begin::Input-->
                <input type="hidden" name="old_file" value="{{ $data->file_name }}" />
            ...
            <div class="fv-row mb-5">
                ...
                @enderror
                @if (\Session::has('cnt_sml'))
                    <span class="invalid-feedback d-block" role="alert">
                        <strong>{!! \Session::get('cnt_sml') !!}</strong>
                    </span>
                @endif
                <!--end::Error-->
            </div>
