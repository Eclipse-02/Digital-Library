...
<div class="card card-xxl-stretch">
    ...
    <div class="card-header align-items-center border-0 mt-4">
        <h3 class="card-title align-items-start flex-column">
            <span class="fw-bolder mb-2 text-dark">View Publishers</span>
            <span class="text-muted fw-bold fs-7">Tampilan Penerbit</span>
        </h3>
        <div class="d-flex">
    ...
    <div class="card-body pt-5">
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Publishers Name</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
